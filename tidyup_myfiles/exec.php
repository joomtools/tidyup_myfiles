...
if ($rename === false)
{
	...
	<p>Ein besonderer Danke geht an die Tester <em>Elisa Foltyn</em>, <em>Christiane Maier-Stadtherr</em> und <em>Thomas Finner</em>, die viel Geduld und Nerven gezeigt haben.</p>
	<?php die;
	}
}
